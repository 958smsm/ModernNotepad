...
| Smart | Grammar-category coloring | **Implemented** | Direct mode switch: Logic & Traditional NLP, OpenAI, Python spaCy, Python NLTK, or Google Cloud Natural Language. |
...
| Smart | Grammar categories / long sentence / passive voice | **Implemented** | Selectable Traditional/OpenAI/spaCy/NLTK/Google Cloud grammar mode; other checks remain local and advisory. |
...
6. **Smart grammatical coloring** — complete with five direct modes and selectable Python IPC transport.
